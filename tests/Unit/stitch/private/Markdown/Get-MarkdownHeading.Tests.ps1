...
Describe "Testing private function Get-MarkdownHeading" -Tags @('unit', 'MarkdownHeading', 'Get' ) {
    Context 'The Get-MarkdownHeading command is available and is valid' {
        BeforeAll {
            $command = Get-Command 'Get-MarkdownHeading'
            $tokens, $errors = @()
