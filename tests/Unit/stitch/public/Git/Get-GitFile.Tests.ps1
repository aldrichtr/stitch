...
Describe "Testing public function Get-GitFile" -Tags @('unit', 'GitFile', 'Get' ) {
    Context 'The Get-GitFile command is available and is valid' {
        BeforeAll {
            $command = Get-Command 'Get-GitFile'
            $tokens, $errors = @()
