...
Describe "Testing public function Checkpoint-GitWorkingDirectory" -Tags @('unit', 'GitWorkingDirectory', 'Checkpoint' ) {
    Context 'The Checkpoint-GitWorkingDirectory command is available and is valid' {
        BeforeAll {
            $command = Get-Command 'Checkpoint-GitWorkingDirectory'
            $tokens, $errors = @()
