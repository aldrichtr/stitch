...
Describe "Testing public function Get-GitHistory" -Tags @('unit', 'GitHistory', 'Get' ) {
    Context 'The Get-GitHistory command is available and is valid' {
        BeforeAll {
            $command = Get-Command 'Get-GitHistory'
            $tokens, $errors = @()
