...
Describe "Testing public function Find-TodoItem" -Tags @('unit', 'TodoItem', 'Find' ) {
    Context 'The Find-TodoItem command is available and is valid' {
        BeforeAll {
            $command = Get-Command 'Find-TodoItem'
            $tokens, $errors = @()
