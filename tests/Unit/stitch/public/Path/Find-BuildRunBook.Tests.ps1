...
Describe "Testing public function Find-BuildRunBook" -Tags @('unit', 'BuildRunBook', 'Find' ) {
    Context 'The Find-BuildRunBook command is available and is valid' {
        BeforeAll {
            $command = Get-Command 'Find-BuildRunBook'
            $tokens, $errors = @()
