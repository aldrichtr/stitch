...
Describe "Testing public function New-StitchBuildRunner" -Tags @('unit', 'StitchBuildRunner', 'New' ) {
    Context 'The New-StitchBuildRunner command is available and is valid' {
        BeforeAll {
            $command = Get-Command 'New-StitchBuildRunner'
            $tokens, $errors = @()
