...
Describe "Testing public function New-StitchRunBook" -Tags @('unit', 'StitchRunBook', 'New' ) {
    Context 'The New-StitchRunBook command is available and is valid' {
        BeforeAll {
            $command = Get-Command 'New-StitchRunBook'
            $tokens, $errors = @()
