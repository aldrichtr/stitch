...
Describe "Testing public function New-StitchConfigurationPath" -Tags @('unit', 'StitchConfigurationPath', 'New' ) {
    Context 'The New-StitchConfigurationPath command is available and is valid' {
        BeforeAll {
            $command = Get-Command 'New-StitchConfigurationPath'
            $tokens, $errors = @()
